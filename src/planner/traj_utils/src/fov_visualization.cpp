...
// void fov_callback(const geometry_msgs::PoseStamped &msg){
...
//   }
void fov_callback(const nav_msgs::Odometry::ConstPtr& msg){
  Eigen::Vector3d fov_p_0(msg->pose.pose.position.x, msg->pose.pose.position.y, msg->pose.pose.position.z);
  Eigen::Quaterniond fov_q_0(msg->pose.pose.orientation.w, msg->pose.pose.orientation.x,  msg->pose.pose.orientation.y, msg->pose.pose.orientation.z);
...
int main(int argc, char** argv) {
  ...
  ros::Subscriber fov_sub_ = nh.subscribe("odom", 100,  fov_callback);
