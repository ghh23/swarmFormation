...
struct MappingData
{
  ...
  Eigen::Vector3d camera_pos_, last_camera_pos_, other_camera_pos_0, other_camera_pos_1, other_camera_pos_2,other_camera_pos_3,other_camera_pos_4,other_camera_pos_5,other_camera_pos_6;
...
private:
  ...
  void cloudCallback(const sensor_msgs::PointCloud2ConstPtr &img);
    ...
    void othercloudCallback0(const sensor_msgs::PointCloud2ConstPtr &img);
  void otherodomCallback0(const nav_msgs::OdometryConstPtr &odom);

  void othercloudCallback1(const sensor_msgs::PointCloud2ConstPtr &img);
  void otherodomCallback1(const nav_msgs::OdometryConstPtr &odom);

    void othercloudCallback2(const sensor_msgs::PointCloud2ConstPtr &img);
  void otherodomCallback2(const nav_msgs::OdometryConstPtr &odom);
    void othercloudCallback3(const sensor_msgs::PointCloud2ConstPtr &img);
  void otherodomCallback3(const nav_msgs::OdometryConstPtr &odom);
    void othercloudCallback4(const sensor_msgs::PointCloud2ConstPtr &img);
  void otherodomCallback4(const nav_msgs::OdometryConstPtr &odom);
    void othercloudCallback5(const sensor_msgs::PointCloud2ConstPtr &img);
  void otherodomCallback5(const nav_msgs::OdometryConstPtr &odom);
    void othercloudCallback6(const sensor_msgs::PointCloud2ConstPtr &img);
  void otherodomCallback6(const nav_msgs::OdometryConstPtr &odom);
  ...
  ros::Subscriber indep_cloud_sub_, indep_odom_sub_, extrinsic_sub_, swarm_cloud_sub_1, other_odom_sub_1, swarm_cloud_sub_0, other_odom_sub_0;

  ros::Subscriber swarm_cloud_sub_2, other_odom_sub_2, swarm_cloud_sub_3, other_odom_sub_3, swarm_cloud_sub_4, other_odom_sub_4;
  ros::Subscriber swarm_cloud_sub_5, other_odom_sub_5, swarm_cloud_sub_6, other_odom_sub_6;
